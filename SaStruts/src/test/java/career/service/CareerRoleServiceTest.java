...
/**
 * {@link CareerRoleService}のテストクラスです。
 * 
 */
...
public class CareerRoleServiceTest extends S2TestCase {
    ...
    /**
     * {@link #careerRoleService}が利用可能であることをテストします。
     * 
     * @throws Exception
     */
    public void testAvailable() throws Exception {
        assertNotNull(careerRoleService);
    }
}