...
/**
 * {@link MstMiddleService}のテストクラスです。
 * 
 */
...
public class MstMiddleServiceTest extends S2TestCase {
    ...
    /**
     * {@link #mstMiddleService}が利用可能であることをテストします。
     * 
     * @throws Exception
     */
    public void testAvailable() throws Exception {
        assertNotNull(mstMiddleService);
    }
}