...
import static career.entity.MstLangNames.*;

/**
 * {@link MstLang}のテストクラスです。
 * 
 */
...
public class MstLangTest extends S2TestCase {
    ...
    public void testFindById() throws Exception {
        jdbcManager.from(MstLang.class).id(1).getSingleResult();
    }
    ...
    public void testLeftOuterJoin_careerLangList() throws Exception {
        jdbcManager.from(MstLang.class).leftOuterJoin(careerLangList()).id(1).getSingleResult();
    }
}