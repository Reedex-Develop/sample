...
import static career.entity.MstRoleNames.*;

/**
 * {@link MstRole}のテストクラスです。
 * 
 */
...
public class MstRoleTest extends S2TestCase {
    ...
    public void testFindById() throws Exception {
        jdbcManager.from(MstRole.class).id(1).getSingleResult();
    }
    ...
    public void testLeftOuterJoin_careerRoleList() throws Exception {
        jdbcManager.from(MstRole.class).leftOuterJoin(careerRoleList()).id(1).getSingleResult();
    }
}